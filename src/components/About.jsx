...
<p className="container-title">What is FuseNFT?</p>
...
<div className="gradient-cards">
    ...
    <div className="container-card bg-white-box">
        ...
        <p className="card-description">Deposit a variety of assets on FuseNFT, enhance your collateral ratio, and unlock liquidity in your wallet.</p>
    </div>
    </div>
    ...
    <div className="container-card bg-yellow-box">
        ...
        <p className="card-description">While your collateral is deposited on FuseNFT, delegate it to earn the highest yield available in the Solana ecosystem.</p>
    </div>
    </div>
    ...
    <div className="container-card bg-blue-box">
        ...
        <p className="card-description">Experience capital efficiency with FuseNFT's 110% collateral ratio, enabling users to leverage up to 11x on their deposits.</p>
    </div>
    </div>
</div>
</div>
